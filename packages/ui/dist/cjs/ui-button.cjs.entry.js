...
const UiButton = class {
    ...
    render() {
        return (index.h("button", { key: '0c99e9fc93f298be0c3f7b07f5493ba62c163af4', type: this.type, class: `btn ${this.variant} ${this.size}`, disabled: this.disabled }, index.h("slot", { key: '888d19ed64e2ba98f8815b2adea4d0040fea7b95' })));
    }
};
