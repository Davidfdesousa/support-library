...
const UiButton = class {
    ...
    render() {
        ...
        return (index.h("button", { key: 'd191940aa961a911a3e5a20357d10c936e1660a0', type: this.type, class: classes, disabled: this.disabled, "aria-disabled": this.disabled ? 'true' : null }, index.h("slot", { key: '37df10059c9c4a11ba4caf2aa93d112303a00028' })));
    }
};
